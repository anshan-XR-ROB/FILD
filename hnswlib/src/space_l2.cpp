...
namespace hnswlib {
    ...
    size_t L2Space::get_data_size() {
        return data_size_;
    }

    DISTFUNC<float> L2Space::get_dist_func() {
        return fstdistfunc_;
    }

    void *L2Space::get_dist_func_param() {
        return &dim_;
    }
    ...
    L2SpaceI::L2SpaceI(size_t dim) {
        fstdistfunc_ = L2SqrI;
        dim_ = dim;
        data_size_ = dim * sizeof(unsigned char);
    }

    size_t L2SpaceI::get_data_size() {
        return data_size_;
    }

    DISTFUNC<int> L2SpaceI::get_dist_func() {
        return fstdistfunc_;
    }

    void * L2SpaceI::get_dist_func_param() {
        return &dim_;
    }
